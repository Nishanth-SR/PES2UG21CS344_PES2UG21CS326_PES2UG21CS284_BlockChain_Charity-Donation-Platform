...
//internal import
import { CharityContext } from "../Context/Charity";
import { Logo, Menu } from "../Components/index";

const NavBar = () => {
  const { currentAccount, connectWallet } = useContext(CharityContext);
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  const menuList = ["BlockChain", "Ethereum", "Donation", "Team-Members"];
  return(
        ...
        <div class="relative flex items-center justify-between">
          ...
          <div class="lg:hidden z-40">
            <button
              ...
              title="Open Menu"
              class="p-2 -mr-1 transition duration-200 rounded focus:otline-none focus:shadow-outline"
