  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-opacity-75 backgroundMain">
        ...
        <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:maxw-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h1 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-6xl sm:leading-none underline">
                Block Chain<br className="hidden md:block" />
              </h1>
              <h3 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none underline">
              ...
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                <form>
                  ...
                  <p className="text-xs text-gray-600 sm:text-sm">
                    Create your Charity to raise funds
                  </p>
                </form>
              </div>
            </div>
